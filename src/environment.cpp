...
std::any Environment::getAt(int distance, SPToken name) { // NOLINT(*-no-recursion)
...
void Environment::assignAt(int distance, SPToken name, const std::any &value) { // NOLINT(*-no-recursion)
